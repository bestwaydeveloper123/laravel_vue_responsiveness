      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row">
              <label for="team" class="col-md-4 col-form-label text-md-right">{{ __('Role') }}</label>
              <div class="col-md-6">
                <select id="team" class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" name="role" value="{{ old('role') }}" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <select id="team" class="form-control{{ $errors->has('team') ? ' is-invalid' : '' }}" name="team" value="{{ old('team') }}">
