...
@section('content')
  <div class="app-body bg-light theme-color">
    <div class="main" id="vue-app">
      ...
      {{-- <input type="hidden" class="form-control" name="account_id" value="{{ $accounthnumber ? $accounthnumber : "Account H# (IE H123456) fill now or from before" }}"> --}}
      <div class="card mb-0">
                ...
                <tbody>
                  @foreach ($fords as $ford)
                    <tr class="body-column">
                      ...
                      <td>
                        <form action="/admin/core/addcore" method="post" id="{{ 'ford-'. $ford->id }}">
                          @csrf
                ...
                <tbody>
                  @foreach ($chryslers as $chrysler)
                    <tr class="body-column">
                      ...
                      <td>
                        <form action="/admin/core/addcore" method="post" id="{{ 'chrysler-'. $chrysler->id }}">
                          @csrf
                ...
                <tbody>
                  @foreach ($mazdas as $mazda)
                    <tr class="body-column">
                      ...
                      <td>
                        <form action="/admin/core/addcore" method="post" id="{{ 'mazda-'. $mazda->id }}">
                          @csrf
                          <center><button type="submit" class="btn btn-outline-success pt-0 pb-0 inventory"><i class="icon-arrow-up"></i></button></center>
                        </form>
                      </td>
