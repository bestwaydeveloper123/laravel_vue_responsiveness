...
<script>
import BootstrapTypeaheadListItem from './BootstrapTypeaheadListItem.vue';
...
export default {
  name: 'BootstrapTypeaheadList',

  components: {
    BootstrapTypeaheadListItem,
  },
