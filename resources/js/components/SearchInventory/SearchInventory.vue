  ...
  <div class="main">
    <div class="card mb-0">
      ...
      <div class="card-body table-responsive">
        <div class="jumbotron p-5 bg-primary">
          <div class="col-4 input-group mx-auto">
            ...
            <div class="input-group-append">
              ...
              <button class="btn btn-success" type="button" id="search-inventory">
        ...
        <table
          id="inventory_table"
          class="width-100 table table-striped table-hover table-sm inventory-fonts bg-gray-200"
        >
          <thead>
...
$(document).ready(function() {
  ...
  var Table = $('#inventory_table').DataTable({
    ...
    searching: false,
    language: {
      emptyTable: 'No data available, please search inventory.',
    },
    columns: [
      { data: 'id' },
      { data: 'title' },
  ...
  $('#terms').on('keyup', function(event) {
    if (event.keyCode === 13) {
      $('#search-inventory').trigger('click');
    }
  })
  $('#search-inventory').on('click', function(event) {
    let obj = {
      terms: $('#terms').val(),
    };
    $.ajax({
